...
<input type="hidden" id="purchase_value" value="<?php echo escape_output(($purchase_sum->purchase_sum)) ?>">
<input type="hidden" id="sale_value" value="<?php echo escape_output(($sale_sum->sale_sum)) ?>">
<input type="hidden" id="waste_value" value="<?php echo escape_output(($waste_sum->waste_sum)) ?>">
<input type="hidden" id="expense_value" value="<?php echo escape_output(($expense_sum->expense_sum)) ?>">
<input type="hidden" id="cust_rcv_value" value="<?php echo escape_output(($customer_due_receive_sum->customer_due_receive_sum)) ?>">
<input type="hidden" id="supp_pay_value" value="<?php echo escape_output(($supplier_due_payment_sum->supplier_due_payment_sum)) ?>">
                                    ...
                                    <li>
                                        ...
                                        <div class="ir_fl_right_c_red_pr_5">
                                            ...
                                            <?php if($value->ing_type=="Plain Ingredient" && $value->is_direct_food!=2  && $value->conversion_rate!=1):?>
                                                <span><?php echo ($total_sale_unit)  && $total_sale_unit>0? getAmtP($total_sale_unit) : getAmtP(0) ?><?php echo " " . $value->unit_name2 ?></span> <span><?= ($totalStock) ? getAmtP($totalStock%$conversion_rate) : getAmtP(0) ?><?= " " . escape_output($value->unit_name)?></span>
                                            <?php else:
                                                $stock_float = (float)((($total_sale_unit)  && $total_sale_unit>0? ($total_sale_unit) : (0))+(($totalStock) ? ($totalStock%$conversion_rate) : (0)));
                                                ?>
                                                <span><?php echo escape_output(getAmtP($stock_float)) ?> <?= " " . escape_output($value->unit_name)?></span>
                                                <?php
                                            endif
                                            ?>
                                        </div>
                  ...
                  $key++;
                    ?>
                        <li>
                            ...
                            <div class="ir_fl_right_c_pr_5">
                                <span><?php echo escape_output(getAmtCustom($value->total_payable)) ?></span>
                            </div>
                        </li>
                        <?php } } ?>
                    </ul>
                    ...
                    ?>
                        <li>
                            ...
                            <div class="ir_fl_right_c_pr_5">
                                ...
                                <span><?php echo escape_output(getAmtPCustom($current_due)) ?></span>
                            </div>
                        </li>
                        <?php } }  } ?>
                    </ul>
