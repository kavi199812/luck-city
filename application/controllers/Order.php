...
class Order extends Cl_Controller {
    ...
    public function add_sale_by_ajax(){
        ...
        $data['total_items'] = trim_checker($this->input->post('totalitem'));
        $data['sub_total'] = trim_checker($this->input->post('sub_total'));
        $data['vat'] = trim_checker($this->input->post('TotalTax'));

        $data['total_payable'] = trim_checker($this->input->post('totalVal'));
        $data['total_item_discount_amount'] = 0;
        $data['sub_total_with_discount'] = trim_checker($this->input->post('sub_total'));
        $data['sub_total_discount_amount'] = 0;
        $data['total_discount_amount'] = 0;
        $data['delivery_charge'] = trim_checker($this->input->post('totalCharge'));;
    ...
    public function onlineAndSelfOrderSetting($id = '') {
        ...
        if (htmlspecialcharscustom($this->input->post('submit'))) {
            ...
            if ($this->form_validation->run() == TRUE&&$imgchk==1&&$imgchk1==1) {
                $outlet_info['base_color'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('base_color')));
                ...
                $outlet_info['phone_number'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('phone_number')));
                $outlet_info['facebook_link'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('facebook_link')));
                $outlet_info['twitter_link'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('twitter_link')));
                $outlet_info['pinterest_link'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('pinterest_link')));
                $outlet_info['delivery_enable_disable'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('delivery_enable_disable')));
                $outlet_info['delivery_charge'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('delivery_charge')));
                $outlet_info['delivery_opening_time'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('delivery_opening_time')));
                $outlet_info['delivery_closing_time'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('delivery_closing_time')));
                $outlet_info['delivery_order_user_id'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('delivery_order_user_id')));
                $outlet_info['dine_in_enable_disable'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('dine_in_enable_disable')));
                $outlet_info['dine_in_code'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('dine_in_code')));
                $outlet_info['mst'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('mst')));
                $outlet_info['dion'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('dion')));
                $outlet_info['dine_in_order_user_id'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('dine_in_order_user_id')));
                $outlet_info['take_away_enable_disable'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('take_away_enable_disable')));
                $outlet_info['take_away_code'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('take_away_code')));
                $outlet_info['take_away_order_user_id'] =htmlspecialcharscustom($this->input->post($this->security->xss_clean('take_away_order_user_id')));
    ...
    public function setOpeningClosingTime($id = '') {
        ...
        if (htmlspecialcharscustom($this->input->post('submit'))) {
            ...
            $date_name =htmlspecialcharscustom($this->input->post($this->security->xss_clean('date_name')));
            $o_time =htmlspecialcharscustom($this->input->post($this->security->xss_clean('o_time')));
            $c_time =htmlspecialcharscustom($this->input->post($this->security->xss_clean('c_time')));
            $r_arr = array();
            $i = 1;
