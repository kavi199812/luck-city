...
if (isset($food_menus) && $food_menus):
    ...
    foreach ($food_menus as $single_menus) {
        ...
        if ($single_menus->parent_id == "0"):
            ...
            $menu_to_show .= '<div class="single_item animate__animated animate__flipInX" data-price="' . $sale_price . '"  data-price_take="' . $sale_price_take . '"  data-price_delivery="' . $sale_price_delivery . '" data-is_variation="' . $is_variation . '" data-veg_status="' . $veg_status1 . '" data-beverage_status="' . $beverage_status . '" data-product_type="' . $single_menus->product_type . '" data-is_promo="' . $is_promo . '" id="item_' . $single_menus->id . '">';
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/POS/css/custom_category_grid.css">
    <style>
        <?php
...
<body>
                        ...
                        <div class="bottom__info">
                            ...
                            <div class="main_bottom">
                                <div
                                    ...
                                    <button id="hold_sale" class="<?php echo escape_output($is_self_order_class) ?>"><i
                                            class="fas fa-hand-rock"></i>
                                        <?php echo lang('hold'); ?></button>

                                    <button data-type="1"
                                        class="<?php echo escape_output(isset($is_online_order) && $is_online_order == "Yes" ? 'self_order_skip' : '') ?> <?php echo escape_output(isset($is_self_order) && $is_self_order == "Yes" ? 'self_order_skip' : '') ?> placeOrderSound place_order_operation <?php echo isset($place_order_tooltip) && $place_order_tooltip == "show" ? "btn_tip" : '' ?>"
                ...
                <script>
                    $(document).ready(function () {
                        ...
                        $('.category_grid_item').on('click', function () {
                            ...
                            // Find the product container for this category
                            // The PHP loop generates divs with id="category_[id]"
                            var productSource = $('#category_' + categoryId);
                            console.log('Product Source:', productSource);
                            console.log('Product Source Length:', productSource.length);
                            ...
                            if (productSource.length > 0) {
                                console.log('Products found, cloning...');
                                // Clone the products (to preserve original for later if needed, though they are hidden)
                                // We use clone(true) to keep event handlers if any are attached directly
                                var products = productSource.clone(true, true);
                                products.children().appendTo(modalContainer);
    ...
    <div class="all__menus">
        <ul class="menu__list">
            ...
            <div>
                ...
                <li>
                    <a href="<?php echo base_url() ?>customer-panel" class="header_menu_icon" target="_blank"
                    ...
                    <div class="left-item b">
                        ...
                        <div class="customer_section">
                            ...
                            <input type="text" class="add_customer_modal_input"
                                placeholder="<?php echo lang('phone'); ?>" id="customer_phone_modal" required>
                        </div>
                        <div class="customer_section">
                                        ...
                                        <div class="right-content">
                                            ...
                                            if (isset($company->sms_service_provider) && $company->sms_service_provider):
                                                ...
                                                <table class="irp_width_100">
                                                    <tr>
                                                        <td><button><label for="check_send_sms"
                                                                    class="check_send_sms"><input id="check_send_sms" <?php echo isset($sms_send_auto) && $sms_send_auto == 2 ? 'checked' : '' ?>
                                                                        type="checkbox"><?php echo lang('send_sms') ?></label></button>
                                                        </td>
                                                        <td><button
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>frequent_changing/js/pos_script_v7.1.1.js"></script>
