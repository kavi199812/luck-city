...
class Update extends Cl_Controller {
    ...
    function __construct(){
        ...
        $this->my_info = json_decode(file_get_contents(base_url('')));
        $this->update = json_decode(file_get_contents(''));
    }
    ...
    public function updateVerification(){
        ...
        $details = json_decode(file_get_contents(base_url('')));
    ...
    public function install_update(){
        ...
        if ($this->input->is_ajax_request()) {
            ...
            $handle = fopen($path, "w");
            if ($handle) {
                $content = '{ "version":"'.$updated_version.'", "url":""}';
                // Write the file
