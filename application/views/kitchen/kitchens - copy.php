            ...
            <div class="table-responsive">
                <table id="datatable" class="table">
                    ...
                    <tr>
                        ...
                        <th class="ir_w_10"><?php echo lang('outlet'); ?></th>
                    ...
                    foreach ($kitchens as $kitchen) { ?>
                        <tr>
                            ...
                            <td><?php echo escape_output(getOutletNameById($kitchen->outlet_id)) ?></td>
                            <td><?php echo escape_output($kitchen->categories) ?></td>
                            <td><a target="_blank" href="<?php echo base_url()?>Kitchen/panel/<?php echo escape_output($kitchen->id)?>" class="btn btn-primary btn-xs"><?php echo lang('enter'); ?></a></td>
