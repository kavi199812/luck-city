        ...
        <div class="table-box">
            ...
            <div class="table-responsive">
                ...
                <table id="datatable" class="table">
                    ...
                    <tr>
                        <th class="ir_w2_txt_center"></th>
                        <th class="ir_w_31"><h4 class="pull-left"><?php echo lang('SalesandTaxesSummary'); ?></h4></th>
                        <th class="ir_w_35"></th>
                        <th class="ir_w_31"></th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th class="ir_w2_txt_center"></th>
                        <th class="ir_w_31"><h4 class="pull-left"><?php echo lang('PaymentMethodWiseBreakdown'); ?>(<?php echo lang('paid_amount'); ?>)</h4></th>
                        <th class=""></th>
                        <th class=""></th>
                    </tr>
                    <?php
                    ...
                    <tr>
                        <th class="ir_w2_txt_center"></th>
                        <th class="ir_w_31"><h4 class="pull-left"><?php echo lang('payment_in_others_currencies'); ?>(<?php echo lang('paid_amount'); ?>)</h4></th>
                        <th class="ir_w_35"></th>
                        <th class="ir_w_31"></th>
                    </tr>
                    <?php
                    ...
                    <?php  if (isset($totalFoodModifierSales)):?>
                        ...
                        <tr>
                            <th class="ir_w2_txt_center"></th>
                            <th class="ir_w_31"><h4 class="pull-left"><?php echo lang('modifier_wise_sales'); ?></h4></th>
                            <th class="ir_w_35"></th>
                            <th class="ir_w_31"></th>
                        </tr>
                        <tr>
                 ...
                 <?php  if (isset($getAllPurchasePaymentZreport)):?>
                    ...
                    <tr>
                        <th class="ir_w2_txt_center"></th>
                        <th class="ir_w_31"><h4 class="pull-left"><?php echo lang('purchase'); ?> (<?php echo lang('paid_amount'); ?>)</h4></th>
                        <th class="ir_w_35"></th>
                        <th class="ir_w_31"></th>
                    </tr>
                    <?php
                  ...
                  if (isset($getAllExpensePaymentZreport)):?>
                    ...
                    <tr>
                        <th class="ir_w2_txt_center"></th>
                        <th class="ir_w_31"><h4 class="pull-left"><?php echo lang('expense'); ?></h4></th>
                        <th class="ir_w_35"></th>
                        <th class="ir_w_31"></th>
                    </tr>
                  ...
                  if (isset($getAllSupplierPaymentZreport)):?>
                    ...
                    <tr>
                        <th class="ir_w2_txt_center"></th>
                        <th class="ir_w_31"><h4 class="pull-left"><?php echo lang('supplier_payment'); ?></h4></th>
                        <th class="ir_w_35"></th>
                        <th class="ir_w_31"></th>
                    </tr>
                  ...
                  if (isset($getAllCustomerDueReceiveZreport)):?>
                    ...
                    <tr>
                        <th class="ir_w2_txt_center"></th>
                        <th class="ir_w_31"><h4 class="pull-left"><?php echo lang('customer_due_receives'); ?></h4></th>
                        <th class="ir_w_35"></th>
                        <th class="ir_w_31"></th>
                    </tr>
                    ...
                    <tr>
                        <th class="ir_w2_txt_center"></th>
                        <th class="ir_w_31"><h4 class="pull-left"><?php echo lang('TotalInHand'); ?></h4></th>
                        <th class="ir_w_35"></th>
                        <th class="ir_w_31"></th>
                    </tr>
                    <tr>
                    ...
                    if (isset($registers)):
                        ...
                        $html_content .= '<tr>
                        <th class="ir_w2_txt_center"></th>
                        <th class="ir_w_31"><h4 class="pull-left">'.lang('InHandSummary').'</h4></th>
                        <th class="ir_w_35"></th>
                        <th class="ir_w_31"></th>
                    </tr>';
