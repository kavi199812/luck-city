...
<section class="main-content-wrapper">
    ...
    <input type="hidden" value="<?php echo $encrypted_id; ?>" id="kitchen_id_hide">
                    ...
                    <div class="form-group">
                        ...
                        <select tabindex="2" class="form-control select2 ir_w_100" id="outlet_id" name="outlet_id">
                            ...
                            foreach ($outlets as $value):
                                ?>
                                <option <?php echo ($kitchen->outlet_id == $value->id) ? 'selected' : ''; ?>  value="<?php echo escape_output($value->id) ?>"><?php echo escape_output($value->outlet_name) ?></option>
                                <?php
                            endforeach;
                            ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="printer_id">
                            ...
                            <?php foreach ($printers as $printer):?>
                                <option <?php echo ($kitchen->printer_id == $printer->id) ? 'selected' : ''; ?> value="<?php echo escape_output($printer->id); ?>"><?php echo escape_output($printer->title); ?></option>
                            <?php endforeach;?>
                        </select>
                    </div>
